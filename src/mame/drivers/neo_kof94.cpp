...
ROM_START( kof94eh1 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "055eh-p1.bin", 0x100000, 0x100000, CRC(3b29945c ))
	ROM_CONTINUE(						0x000000, 0x100000 )

	NEO_SFIX_128K( "055-s1.bin", CRC(825976c1 ))

	NEO_BIOS_AUDIO_128K( "055-m1.bin", CRC(f6e77cf5 ))

	ROM_REGION( 0x600000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "055-v1.bin", 0x000000, 0x200000, CRC(8889596d ))
	ROM_LOAD( "055-v2.bin", 0x200000, 0x200000, CRC(25022b27 ))
	ROM_LOAD( "055-v3.bin", 0x400000, 0x200000, CRC(83cf32c0 ))

	

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "055-c1.bin", 0x000000, 0x200000, CRC(b96ef460 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "055-c2.bin", 0x000001, 0x200000, CRC(15e096a7 )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "055-c3.bin", 0x400000, 0x200000, CRC(54f66254 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "055-c4.bin", 0x400001, 0x200000, CRC(0b01765f )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "055-c5.bin", 0x800000, 0x200000, CRC(ee759363 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "055-c6.bin", 0x800001, 0x200000, CRC(498da52c )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "055-c7.bin", 0xc00000, 0x200000, CRC(62f66888 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "055-c8.bin", 0xc00001, 0x200000, CRC(fe0a235d )) /* Plane 2,3 */
ROM_END

ROM_START( kof94eho )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "055eho-p1.bin", 0x100000, 0x100000, CRC(255487EA ))
	ROM_CONTINUE(						0x000000, 0x100000 )
